...
```{r, echo=FALSE}
setwd("/Users/juliarager/IEHS Dropbox/Julia Rager/Research Projects/1_SRP/4_DMAC/DMAC Training Modules/Training_Modules/1_Chapter 1/1_1_Setting up R/Clean_Files/")
```
...
csv.dataset <- read.csv("Module1_1_ExampleData.csv")

# Read in the .txt data
txt.dataset <- read.table("Module1_1_ExampleData.txt")
```
